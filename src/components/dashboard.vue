              ...
              >
                ...
                <tbody>
                  ...
                  >
                    ...
                    >
                      <!-- <span
                        :class="`flag f-${server.country_code.toLowerCase()} rounded w-5`"
                      ></span> -->
                      <!-- <country-flag :country="server.country-flag" size="big"></country-flag> -->
...
import { Menu, MenuButton, MenuItem, MenuItems } from "@headlessui/vue";
import { ChevronDownIcon } from "@heroicons/vue/20/solid";
import headerTop from "/src/components/ui/header.vue";
